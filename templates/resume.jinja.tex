...
\makecvheader[C]
\makecvfooter{\today}{\VAR{name[0]} \VAR{name[1]}}{\thepage}
...
\begin{cventries}
  ...
  \cventry{\VAR{entry.title}}{\VAR{entry.organization}}{\VAR{entry.location}}{\VAR{entry.date[0]}\textemdash \VAR{entry.date[1]}}
